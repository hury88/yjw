                        ...
                        switch(parseInt(data.brand_list[i].international)){//区分国内国外
                            case 0:
                                    ...
                                    if(data.brand_list[i].brand_image!=""){
                                        ...
                                        domestic.append('<li><a href="jpSelect.html?'+data.brand_list[i].brand_value+'='+data.brand_list[i].brand_name+'" target="_blank"><img src="/style/images/amn.jpg"></a></li>');
                                    }
                            ...
                            case 1:
                                if(data.brand_list[i].brand_image!=""){
                                    ...
                                    internal.append('<li><a href="jpSelect.html?'+data.brand_list[i].brand_value+'='+data.brand_list[i].brand_name+'" target="_blank"><img src="/style/images/amn.jpg"></a></li>');
                                }
                                break;
                            case 2:
                                ...
                                if(data.brand_list[i].brand_image!=""){
                                    ...
                                    youozhi.append('<li><a href="jpSelect.html?'+data.brand_list[i].brand_value+'='+data.brand_list[i].brand_name+'" target="_blank"><img src="/style/images/amn.jpg"></a></li>');
                                }
                            ...
                            case 3:
                                ...
                                if(data.brand_list[i].brand_image!=""){
                                    ...
                                    gongchang.append('<li><a href="jpSelect.html?'+data.brand_list[i].brand_value+'='+data.brand_list[i].brand_name+'" target="_blank"><img src="/style/images/amn.jpg"></a></li>');
                                }
                        ...
                        switch(parseInt(data.brand_list[i].international)){//区分国内国外
                            case 0:
                                    ...
                                    if(data.brand_list[i].brand_image!=""){
                                        ...
                                        domestic.append('<li><a href="jjSelect.html?'+data.brand_list[i].brand_value+'%'+prodBrandVal+'" target="_blank"><img src="/style/images/amn.jpg"></a></li>');
                                    }
                            ...
                            case 1:
                                if(data.brand_list[i].brand_image!=""){
                                    ...
                                    internal.append('<li><a href="jjSelect.html?'+data.brand_list[i].brand_value+'%'+prodBrandVal+'" target="_blank"><img src="/style/images/amn.jpg"></a></li>');
                                }
                                break;
                        }
                        break;
