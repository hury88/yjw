        ...
        <li class="yiji_li">
          ...
          <ul class="erji clr" style="display:none">
            ...
            foreach ($data2 as $key2 => $bd2) {
              ...
              ?>
              <li ><a <?php if($bd2['img1'])echo 'style="background:url('.src($bd2['img1']).') right center no-repeat;background-size: contain;"' ?> data-index="0" class="menua" href="<?php echo $linkurl?>" title="<?php echo $bd2['catname'],'-',$bd2['pid'],':',$bd2['id'] ?>" target="righthtml"><?php echo cutstr($bd2['catname'],20,'')?></a></li>
              ...
              foreach ($data3 as $key3 => $bd3) {
                ...
                if(!empty($bd3['linkurl']))
                  ...
                  $linkurl2 = getUrl(array('pid'=>$pid,'ty'=>$ppid,'tty'=>$bd3['id']),config('webarr.showtype2')[$showtype2]);

                ?>

                <li class="pro_type2" style="padding-left:20px;"><a <?php if($bd3['img1'])echo 'style="background:url('.src($bd3['img1']).') left center no-repeat;background-size: 30%;"' ?> href="<?php echo $linkurl2?>" target="righthtml"><?php echo $bd3['catname']?></a></li>
