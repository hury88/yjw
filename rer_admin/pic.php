...
$ci_size = '';
if ($ci == 1) {
  $ci_size = '<b style="color:red">1020X980px</b>';
}
...
<body>
    ...
    <div class="right clr">
      ...
      <div class="col-md-12">
        ...
        <h2 class="top_title"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>.jpg,.png,.gif图片上传 <?php echo $ci_size; ?></h2>
        ...
        <div class="neirong clr">
         ...
         <table cellpadding="0" cellspacing="0" class="table clr">
          ...
          <tr>
           ...
           <td><?=$img1?> </td>
<?php if ($ci==1): ?>
           <td><?=htmlspecialchars_decode($content)?> </td>
<?php else: ?>
           <td><?=$title?> </td>
<?php endif ?>
