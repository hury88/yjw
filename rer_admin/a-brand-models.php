...
<tbody>
    <tr>
        ...
        <td><?=$id?></td>
        <td>
             <a href="a-product.php?prod_brand=<?=$brand_id?>&prod_series=<?=$id?>&callbackEvents=close" class="newLayerWindow layui-btn layui-btn-xs" style="color:#fff;height: 22px; line-height: 22px; padding: 0 5px; font-size: 12px;">下属商品(<?=ModelFactory('product')->countByProd_series($id)?>)</a>|
