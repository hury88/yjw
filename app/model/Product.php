...
class Product extends Model
{
    ...
    const TABLE_FIELD = 'id as prod_id,cust_id, "/uploadfile/upload/" as path,img_path as big_img_path,lens_refra_index,lens_type,mirr_width,nose_width,pay_type,prod_brand,prod_color,prod_material,prod_name,prod_series,prod_shape,prod_type,sku_id,version,shape,style';
